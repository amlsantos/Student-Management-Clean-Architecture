...
public record StudentDisenrollmentCommand : IRequest<Result>
{
...
public class StudentDisenrollmentCommandHandler : IRequestHandler<StudentDisenrollmentCommand, Result>
{
