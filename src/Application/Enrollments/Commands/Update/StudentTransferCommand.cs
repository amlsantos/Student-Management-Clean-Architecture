...
public class StudentTransferCommandHandler : ICommandHandler<StudentTransferCommand, Result>
{
    private readonly IUnitOfWork _unitOfWork;

    public StudentTransferCommandHandler(IUnitOfWork unitOfWork) => _unitOfWork = unitOfWork;
